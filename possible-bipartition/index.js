    ...
    while (stack.length) {
      ...
      for (dislikedPerson of dislikeHash[person]) {
        if (dislikedPerson in groupAssignments) {
          ...
          groupAssignments[dislikedPerson] = groupAssignments[person] === 0 ? 1 : 0;
